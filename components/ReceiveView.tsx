...
export const ReceiveView = ({ username, onClose }: any) => (
  <div className="max-w-md mx-auto animate-in fade-in duration-500">
    <div className="bg-white rounded-[4rem] p-12 text-center shadow-2xl border-b-[16px] border-[#fcf4f6]">
      <div className="flex justify-end mb-4">
        <button onClick={onClose} className="p-3 bg-gray-50 rounded-full text-gray-400"><X size={20}/></button>
      </div>
      ...
      <p className="text-gray-400 text-sm font-bold">このQRを読み取ってもらうか、IDを伝えて送金を受け取れます。</p>
    </div>
  </div>
);